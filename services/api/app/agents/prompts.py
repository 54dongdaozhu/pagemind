...
- practice：用户想生成练习、自测题、应用题或复述提示
- grade：用户想批改答案、判断回答是否正确或分析错因
...
PRACTICE_GENERATION_PROMPT = """你是 PracticeAgent，负责基于学习文档生成帮助理解的练习。
...
只依据给定文档内容，不编造文档外事实。
只输出 JSON：
{"items":[{"type":"short_answer","question":"...","reference_answer":"...","target_knowledge":["..."],"difficulty":"medium"}]}"""


ANSWER_GRADING_PROMPT = """你是 PracticeAgent 的批改模式，负责基于文档上下文批改用户回答。
...
只输出 JSON：
{"score":0.8,"is_correct":true,"feedback":"...","missing_points":["..."],"review_targets":["..."]}"""
