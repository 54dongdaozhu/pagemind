...
> 一款面向通用文档阅读、知识整理和深度理解场景的 AI 文档学习工具，能从 docx 文档中自动提取核心知识点，通过高亮 + 智能讲解帮助用户高效消化内容。
...
浏览器访问 http://localhost:5173 → 上传一份 docx 文档 → 等待知识点提取完成 → 开始阅读与整理
